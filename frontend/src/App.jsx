    ...
    <div className="page">
      ...
      <section className="report">
        ...
        <article>
          ...
          <p>
            Se trabajó con datos públicos oficiales del INDEC. Se aplicó un
            proceso de curaduría sobre los microdatos de la EPH para garantizar
            la <strong>trazabilidad metodológica</strong>. La elección permite
            validar la "feminización de la pobreza" con respaldo estadístico
            oficial.
          </p>
        </article>
        ...
        <article>
          ...
          <ul>
            ...
            <li>
              Mapa coropletico: representa diferencias espaciales de forma
              inmediata.
            </li>
            <li>
              Torta y dona: sintetizan composiciones (educacion e informalidad)
              en un vistazo.
            </li>
            <li>
              Barras agrupadas: permiten contrastar dos medidas por grupo (uso
              del tiempo).
            </li>
          </ul>
        </article>
        ...
        <article>
          ...
          <p>
            Se eligio Plotly.js sobre React por su interactividad nativa, buena
            calidad visual, soporte de multiples tipos de grafico y facilidad
            para integrar exploracion en una landing.
          </p>
        </article>
